...
const ServiceDetail = (props) => {
  ...
  let content = parse(props.service.text)
  // let content = parse('<h1>single</h1>');
    ...
    >
      <div className="service-detail">
        <div className="service-detail__info">
          {content}
          {/* <div dangerouslySetInnerHTML={{__html: props.service.text}}></div> */}
          {/* <p>
            ...
            строения, но и удобство и экономичность его эксплуатации. Поэтому
            эту работу следует доверять только высококвалифицированным
            специалистам.
          </p>
          <h3>АРХИТЕКТУРНОЕ ПРОЕКТИРОВАНИЕ В МИНСКЕ И БЕЛАРУСИ</h3>
          <p>
            Эффективное архитектурное проектирование зданий и сооружений в
            Минске и Беларуси возможно лишь при грамотном выполнении всех его
            этапов. Наши специалисты детально прорабатывают каждый из них – от
            анализа первичной информации об объекте и подготовки технического
            задания, подготовки эскизов до создания рабочего проекта и
          ...
          <p>
            ...
            коттеджей, бизнес-центров, торговых объектов, офисов и других
            строений любой сложности. Мы поможем определить архитектурный стиль
            с учетом индивидуальных предпочтений заказчика и выполнить
            разработку проекта в минимальный срок.
          </p>
          <p>
            ...
            правил и существующие нормативные акты. Архитектурный проект
            включает в себя:
          </p> */}
        </div>
